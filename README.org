...
Account-separated, monthly time-sharded:

#+BEGIN_SRC
data/
  accounts/
    chase-checking-a]1b2/
      account.json            # metadata, institution info
      2024/
...
- One directory per account (named by institution + last 4 or hash)
